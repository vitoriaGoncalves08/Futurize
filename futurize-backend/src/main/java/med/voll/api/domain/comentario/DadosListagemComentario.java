...
public record DadosListagemComentario(Long id, String titulo_comentario, String descricao_comentario, Date data_comentario, Usuario usuario_comentario, Atividade atividadeComentada ) {
