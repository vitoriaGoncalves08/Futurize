package med.voll.api.atividade;
    ...
    public record DadosListagemAtividade(long id, String titulo, String descricacao, Date inicio, Date encerramento, Estado estado, Dificuldade dificuldade, int prioridade, String tempo_execucao, Projeto projeto, Usuario responsavel, Boolean ativo){
